        ...
        <div className="footer-container">
          <div className="footer-section">
            ...
            <ul>
              ...
              <li>
                <a href="#">Chính sách đơn đồng phục</a>
              </li>
              <li>
          ...
          <div className="footer-section">
            ...
            <p>
              Chúng tôi luôn trân trọng và mong đợi mọi ý kiến đóng góp từ khách
              hàng để có thể nâng cấp trải nghiệm dịch vụ và sản phẩm tốt hơn
              nữa.
            </p>
            <p>
            ...
            <p>
              <strong>Email</strong>
              <br />
              chamsockhachhang@fashionista.vn
            </p>
            <div
